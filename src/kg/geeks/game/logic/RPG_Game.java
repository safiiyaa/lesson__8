...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Avrora avrora = new Avrora(200, 20, "Avrora");
        Golem golem = new Golem(390, 10, " Golem");
        Druid druid = new Druid(220, 20, "Druid");
        Hero[] heroes = {warrior1, warrior2, doc, assistant, magic, berserk, avrora, golem, druid};
